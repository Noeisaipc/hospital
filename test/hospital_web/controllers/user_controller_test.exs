defmodule HospitalWeb.UserControllerTest do
  use HospitalWeb.ConnCase

  alias Hospital.Accounts

  @create_attrs %{correo: "some correo", edad: 42, nombre: "some nombre", password: "some password", tipo: 42}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated correo"
    end
