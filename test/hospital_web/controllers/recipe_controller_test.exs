defmodule HospitalWeb.RecipeControllerTest do
  use HospitalWeb.ConnCase

  alias Hospital.Files

  @create_attrs %{fecha: ~D[2010-04-17], medicamentos: "some medicamentos"}
  ...
  def fixture(:recipe) do
    {:ok, recipe} = Files.create_recipe(@create_attrs)
    recipe
  end
  ...
  describe "update recipe" do
    ...
    test "redirects when data is valid", %{conn: conn, recipe: recipe} do
      ...
      assert html_response(conn, 200) =~ "some updated medicamentos"
    end
