defmodule HospitalWeb.PatientControllerTest do
  use HospitalWeb.ConnCase

  alias Hospital.Agenda

  @create_attrs %{altura: "some altura", edad: 42, nombre: "some nombre", peso: 120.5}
  ...
  def fixture(:patient) do
    {:ok, patient} = Agenda.create_patient(@create_attrs)
    patient
  end
  ...
  describe "update patient" do
    ...
    test "redirects when data is valid", %{conn: conn, patient: patient} do
      ...
      assert html_response(conn, 200) =~ "some updated altura"
    end
